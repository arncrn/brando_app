...
const _findCustomerByName = async (name) => { // make subquery with findOrderByCustomerName
...
const findByCustomerName = async (customerName) => { // make subquery with findCustomerByName
